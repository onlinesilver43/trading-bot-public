...
def main():
    ...
    print("\n💡 Usage:")
    print(
        "  python3 test_phase4_integration.py                    # Run all tests with test data"
    )
    print(
        "  python3 test_phase4_integration.py --real-data        # Run all tests with real data"
    )
    print(
        "  python3 test_phase4_integration.py --deployment       # Run only deployment tests"
    )
    print(
        "  python3 test_phase4_integration.py --simple           # Run only simple tests"
    )
    print(
        "  python3 test_phase4_integration.py --suite            # Run only suite tests"
    )
