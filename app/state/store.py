...
def ensure_defaults(state: dict, cfg) -> dict:
    defaults = {
        ...
        "start_cash_usd": cfg.start_cash_usd, "start_coin_units": cfg.start_coin_units,
        "cash_usd": cfg.start_cash_usd, "coin_units": cfg.start_coin_units,
        "last_price": None, "equity_usd": cfg.start_cash_usd,
        ...
        "rules": {
            ...
            "THRESHOLD_PCT": cfg.threshold_pct, "MIN_TRADE_USD": cfg.min_trade_usd,
            "FAST": cfg.fast, "SLOW": cfg.slow, "FEE_RATE": cfg.fee_rate
        }
    }
