...
def get_enhanced_system_health():
    ...
    try:
        ...
        try:
            ...
            if "permission denied" in str(e).lower() or "connection refused" in str(e).lower():
                container_status = {"message": "Docker daemon access not available (containerized environment)"}
            else:
