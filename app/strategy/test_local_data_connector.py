...
class TestDataConnector:
    ...
    def generate_test_data(self, symbol: str, interval: str, days: int = 30) -> pd.DataFrame:
    ...
    def get_symbol_data(self, symbol: str, interval: str, limit: int = 1000) -> Optional[pd.DataFrame]:
                ...
                for interval in intervals:
                    ...
                    if sample_df is not None:
                        summary["sample_data"][symbol][interval] = {
                            ...
                            "date_range": {
                                "start": sample_df.iloc[0].to_dict() if len(sample_df) > 0 else None,
                                "end": sample_df.iloc[-1].to_dict() if len(sample_df) > 0 else None
                            }
                        }
